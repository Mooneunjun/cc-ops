...
export function TransactionDetailModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-none h-[100dvh] max-h-none sm:max-w-[85vw] sm:max-h-[90vh] sm:h-auto p-0 flex flex-col">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="text-muted-foreground mb-1">송금인명</div>
                      <div className="font-medium">
                    ...
                    <div>
                      <div className="text-muted-foreground mb-1">송금국가</div>
                    ...
                    <div>
                      ...
                      <div className="text-xs">{transaction.paymentOption}</div>
                    </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-muted-foreground mb-1">수취인명</div>
                      <div className="font-medium">
                    ...
                    {transaction.detailReciMobile && (
                      <div>
                        <div className="text-muted-foreground mb-1">연락처</div>
                        <div>{transaction.detailReciMobile}</div>
                      </div>
                    )}
                    <div>
                      <div className="text-muted-foreground mb-1">지급국가</div>
                      <div className="font-medium">{transaction.receive}</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1">지급통화</div>
                      <div className="font-medium">{transaction.dest}</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1">지급금액</div>
                      <div className="font-semibold">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  {transaction.coupon !== undefined && (
                    <div>
                      ...
                      <div className="font-medium">
                        {formatAmount(transaction.coupon)} {transaction.source}
                      </div>
                    </div>
                  )}
                </div>
